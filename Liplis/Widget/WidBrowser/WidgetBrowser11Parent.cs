...
{
    public partial class WidgetBrowser11Parent : WidgetBaseParent
    {
        string url;
        int interval;
        ...
        public WidgetBrowser11Parent(ObjWidgetSetting setting, ActivityRssReader arr, WidgetBaseSetting mwm, string url, int interval)
