...
{
    public partial class WidgetMemParent : WidgetBaseParent
    {
        ///====================================================================
        ///
        ///                           onCreate
        ...
        /// コンストラクター
        /// </summary>
        #region WidgetMemParent
        public WidgetMemParent(ObjWidgetSetting o, ActivityWidget a, WidgetBaseSetting s)
            : base(o, a, s)
        {
            InitializeComponent();
        }
