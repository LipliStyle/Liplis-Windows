...
{
    public partial class WidgetHddParent : WidgetBaseParent
    {
        ///====================================================================
        ///
        ///                           onCreate
        ...
        /// コンストラクター
        /// </summary>
        #region WidgetHddParent
        public WidgetHddParent(ObjWidgetSetting o, ActivityWidget a, WidgetBaseSetting s)
            : base(o, a, s)
        {
            InitializeComponent();
        }
        ...
        {
            f2 = new WidgetHddBase(o,(WidgetHddSetting)s);
        }
        #endregion
