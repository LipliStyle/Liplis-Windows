...
{
    public partial class _WidgetRssBase : WidgetBaseBase
    {
        ///=====================================
        /// プロパティ
        private string              url;
        ...
        public _WidgetRssBase(ObjWidgetSetting o, WidgetRssSetting s)
        {
            this.url      = s.url;
        ...
        private void WidgetRss12Base_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e) { this.mouseMoveWidget(e); }
        #endregion
