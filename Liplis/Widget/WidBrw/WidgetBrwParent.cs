...
{
    public partial class WidgetBrwParent : WidgetBaseParent
    {
        private string url;
        ...
        public WidgetBrwParent(ObjWidgetSetting o, ActivityWidget a, WidgetBaseSetting s)
           : base(o, a, s)
        {
            WidgetBrwSetting ss = (WidgetBrwSetting)s;                                      //設定メッセージを変換しておく
            InitializeComponent();
        ...
        {
            WidgetBrwSetting ss = (WidgetBrwSetting)s;
            f2 = new WidgetBrwBase(o, ss);
        }
        #endregion
